    ...
    return (
        <div>
            {action !== "new" ? <div className='text-center'>
                <Link to={'/account/places/new'} className='bg-primary px-6 py-2 rounded-full inline-flex text-white gap-1'>
                ...
                <div>
                    <form>
                        ...
                        <div className='flex gap-4'>
                            ...
                            <button className='rounded-2xl font-semibold  w-[20%]'>Add photo</button>
                        </div>
                        <div className='mt-2 grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6'>

                            <button className='flex gap-1 bg-transparent border justify-center items-center rounded-2xl p-8 text-2xl text-gray-500'>
                        ...
                        <textarea />
                        <h2 className='text-2xl mt-4 font-semibold'>Check in&out times,max guest</h2>
                        <p className='text-gray-500 text-sm'>Add check in out times,remember to have some time window for cleaning the room between guests</p>
